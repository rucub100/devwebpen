...
public class CertConfig {
    ...
    /**
     * Constructs a {@code CertConfig} with the given validity and CRL distribution
     * point.
     *
    ...
    public CertConfig(Duration validity, String crlDistributionPoint) {
        ...
        if (crlDistributionPoint != null) {
            this.crlDistributionPoint = crlDistributionPoint.isBlank() ? null : crlDistributionPoint;
        }
    }
